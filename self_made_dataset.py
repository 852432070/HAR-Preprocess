...
if __name__ == '__main__':
    ...
    np.save('/data/wang_sc/datasets/PAMAP2_Dataset/Processed_self_made/x_train', x_train)
    np.save('/data/wang_sc/datasets/PAMAP2_Dataset/Processed_self_made/x_test', x_test)
    np.save('/data/wang_sc/datasets/PAMAP2_Dataset/Processed_self_made/y_train', y_train)
    np.save('/data/wang_sc/datasets/PAMAP2_Dataset/Processed_self_made/y_test', y_test)

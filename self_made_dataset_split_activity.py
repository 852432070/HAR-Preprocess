...
def generate(window_size, step, is_test):
    ...
    for file in files:
        ...
        if is_test and label[0] < test_activity:
            continue
        elif is_test == False and label[0] >= test_activity:
            continue
...
if __name__ == '__main__':
    ...
    np.save('/data/wang_sc/datasets/PAMAP2_Dataset/Processed_self_made_unseen_activity_7/x_train', x_train)
    np.save('/data/wang_sc/datasets/PAMAP2_Dataset/Processed_self_made_unseen_activity_7/x_test', x_test)
    np.save('/data/wang_sc/datasets/PAMAP2_Dataset/Processed_self_made_unseen_activity_7/y_train', y_train)
    np.save('/data/wang_sc/datasets/PAMAP2_Dataset/Processed_self_made_unseen_activity_7/y_test', y_test)
